...
set(Qt5NetworkAuth_VERSION_STRING 5.9.8)
...
macro(_populate_NetworkAuth_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5NetworkAuth_install_prefix}/lib/${LIB_LOCATION}")
    _qt5_NetworkAuth_check_file_exists(${imported_location})
    set_target_properties(Qt5::NetworkAuth PROPERTIES
        "INTERFACE_LINK_LIBRARIES" "${_Qt5NetworkAuth_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        "IMPORTED_SONAME_${Configuration}" "libQt5NetworkAuth.so.5"
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5NetworkAuth_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::NetworkAuth)
    ...
    set(Qt5NetworkAuth_PRIVATE_INCLUDE_DIRS
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.9.8"
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.9.8/QtNetworkAuth"
    )
    ...
    foreach(_module_dep ${_Qt5NetworkAuth_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.8 ${_Qt5NetworkAuth_FIND_VERSION_EXACT}
    ...
    _populate_NetworkAuth_target_properties(RELEASE "libQt5NetworkAuth.so.5.9.8" "" )
