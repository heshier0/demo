...
HI_S32 OpenMP3Decoder(HI_VOID *pDecoderAttr, HI_VOID **ppDecoder)
{
    ...
    hi_memset(pstDecoder, sizeof(ADEC_MP3_DECODER_S), 0, sizeof(ADEC_MP3_DECODER_S));
    *ppDecoder = (HI_VOID *)pstDecoder;
    ...
    hi_memcpy(&pstDecoder->stMP3Attr, sizeof(ADEC_ATTR_MP3_S), pstAttr, sizeof(ADEC_ATTR_MP3_S));
