...
typedef enum hiPIC_SIZE_E
{
    ...
    PIC_QVGA,       /* 320 * 240 */
    PIC_VGA,        /* 640 * 480 */   
    PIC_1080P_ROT,  /* 1080 * 1920 */
    PIC_720P_ROT,   /* 720 * 1280 */
    PIC_D1_PAL_ROT, /* 576 * 720 */ 
    PIC_CIF_ROT,    /* 288 * 352 */
    PIC_BUTT
} PIC_SIZE_E;
...
HI_S32 SAMPLE_COMM_VENC_Creat(VENC_CHN VencChn, PAYLOAD_TYPE_E enType, SIZE_S * pstSize, SAMPLE_RC_E enRcMode, HI_S32 s32FrameRate, HI_S32 s32BitRate, HI_S32 s32Gop, HI_U32 u32Profile, HI_BOOL bRcnRefShareBuf, VENC_GOP_ATTR_S *pstGopAttr);
HI_S32 SAMPLE_COMM_VENC_Start(VENC_CHN VencChn, PAYLOAD_TYPE_E enType, SIZE_S * pstSize, SAMPLE_RC_E enRcMode, HI_S32 s32FrameRate, HI_S32 s32BitRate, HI_S32 s32Gop, HI_U32 u32Profile, HI_BOOL bRcnRefShareBuf,VENC_GOP_ATTR_S *pstGopAttr);
...
/* added rpdzk ivy for multi user lcd config */
...
/*============================= mipi 5.5 inch 720x1280 lcd config====================================*/
combo_dev_cfg_t 	MIPI_TX_5_5INCH_720X1280_60_CONFIG ;
VO_SYNC_INFO_S 		MIPI_TX_5_5INCH_720X1280_60_SYNC_INFO ;
VO_USER_INTFSYNC_INFO_S MIPI_TX_5_5INCH_720X1280_60_USER_INTFSYNC_INFO ;
lcd_resoluton_t 	MIPI_TX_5_5INCH_720X1280_60_LCD_RESOLUTION ;
HI_VOID 		InitScreen_mipi_5_5inch_720x1280(HI_S32 s32fd);
