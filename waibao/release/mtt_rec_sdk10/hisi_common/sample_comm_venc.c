...
#if 0 //海思创建编码通道备份
HI_S32 SAMPLE_COMM_VENC_Creat(VENC_CHN VencChn, 
    ...
    switch (enType)
    {
        case PT_H265:
        {
            if (SAMPLE_RC_CBR == enRcMode)
            {
                ...
                stH265Cbr.u32Gop            = (s32Gop > 0)?(HI_U32)s32Gop:u32Gop;
                stH265Cbr.u32StatTime       = u32StatTime; /* stream rate statics time(s) */
                stH265Cbr.u32SrcFrameRate   = u32FrameRate; /* input (vi) frame rate */
                stH265Cbr.fr32DstFrameRate  = (s32FrameRate > 0)?s32FrameRate:u32FrameRate; /* target frame rate */
                switch (enSize)
                {
                ...
                if (s32BitRate > 0)
                	stH265Cbr.u32BitRate = s32BitRate;
            ...
            else if (SAMPLE_RC_FIXQP == enRcMode)
            {
                ...
                stH265FixQp.u32Gop              = (s32Gop > 0)?(HI_U32)s32Gop:u32Gop;;
                stH265FixQp.u32SrcFrameRate     = u32FrameRate;
                stH265FixQp.fr32DstFrameRate    = (s32FrameRate > 0)?s32FrameRate:u32FrameRate;
            ...
            else if (SAMPLE_RC_VBR == enRcMode)
            {
                ...
                stH265Vbr.u32Gop           = (s32Gop > 0)?(HI_U32)s32Gop:u32Gop;;
                stH265Vbr.u32StatTime      = u32StatTime;
                stH265Vbr.u32SrcFrameRate  = u32FrameRate;
                stH265Vbr.fr32DstFrameRate = (s32FrameRate > 0)?s32FrameRate:u32FrameRate;
                switch (enSize)
                {
                    case PIC_QVGA:    /* 320 * 240 */
                    case PIC_CIF:
                ...
                if (s32BitRate > 0)
                	stH265Vbr.u32MaxBitRate = s32BitRate;
            ...
            else if(SAMPLE_RC_AVBR == enRcMode)
            {
                ...
                stH265AVbr.u32Gop         = (s32Gop > 0)?(HI_U32)s32Gop:u32Gop;;
                stH265AVbr.u32StatTime    = u32StatTime;
                stH265AVbr.u32SrcFrameRate  = u32FrameRate;
                stH265AVbr.fr32DstFrameRate = (s32FrameRate > 0)?s32FrameRate:u32FrameRate;
                switch (enSize)
                {
                    case PIC_QVGA:    /* 320 * 240 */
                    case PIC_CIF:
                    case PIC_CIF_ROT:	
                        stH265AVbr.u32MaxBitRate = 512;
                        break;
                ...
                if (s32BitRate > 0)
                	stH265AVbr.u32MaxBitRate = s32BitRate;
            ...
            else if(SAMPLE_RC_QVBR == enRcMode)
            {
                ...
                stH265QVbr.u32Gop         = (s32Gop > 0)?(HI_U32)s32Gop:u32Gop;;
                stH265QVbr.u32StatTime    = u32StatTime;
                stH265QVbr.u32SrcFrameRate  = u32FrameRate;
                stH265QVbr.fr32DstFrameRate = (s32FrameRate > 0)?s32FrameRate:u32FrameRate;
                switch (enSize)
                {
                    case PIC_QVGA:    /* 320 * 240 */
                    case PIC_CIF:
                    case PIC_CIF_ROT:
                        stH265QVbr.u32TargetBitRate = 512;
                        break;
                    ...
                    case PIC_448x768:        
                    case PIC_D1_PAL_ROT:            	
                        stH265QVbr.u32TargetBitRate = 1024 * 2;
                        break;
                ...
                if (s32BitRate > 0)
                	stH265QVbr.u32TargetBitRate = s32BitRate;                
            ...
            else if(SAMPLE_RC_CVBR == enRcMode)
            {
                ...
                stH265CVbr.u32Gop         = (s32Gop > 0)?(HI_U32)s32Gop:u32Gop;;
                stH265CVbr.u32StatTime    = u32StatTime;
                stH265CVbr.u32SrcFrameRate  = u32FrameRate;
                stH265CVbr.fr32DstFrameRate = (s32FrameRate > 0)?s32FrameRate:u32FrameRate;
            ...
            else if(SAMPLE_RC_QPMAP == enRcMode)
            {
                ...
                stH265QpMap.u32Gop           = (s32Gop > 0)?(HI_U32)s32Gop:u32Gop;;
                stH265QpMap.u32StatTime      = u32StatTime;
                stH265QpMap.u32SrcFrameRate  = u32FrameRate;
                stH265QpMap.fr32DstFrameRate = (s32FrameRate > 0)?s32FrameRate:u32FrameRate;
        ...
        case PT_H264:
        {
            if (SAMPLE_RC_CBR == enRcMode)
            {
                ...
                stH264Cbr.u32Gop                = (s32Gop > 0)?(HI_U32)s32Gop:u32Gop;; /*the interval of IFrame*/
                stH264Cbr.u32StatTime           = u32StatTime; /* stream rate statics time(s) */
                stH264Cbr.u32SrcFrameRate       = u32FrameRate; /* input (vi) frame rate */
                stH264Cbr.fr32DstFrameRate      = (s32FrameRate > 0)?s32FrameRate:u32FrameRate; /* target frame rate */
                switch (enSize)
                {
                    case PIC_CIF:
                    case PIC_CIF_ROT:
                ...
                if (s32BitRate > 0)
                    stH264Cbr.u32BitRate = s32BitRate;
            ...
            else if (SAMPLE_RC_FIXQP == enRcMode)
            {
                ...
                stH264FixQp.u32Gop           = (s32Gop > 0)?(HI_U32)s32Gop:u32Gop;;
                stH264FixQp.u32SrcFrameRate  = u32FrameRate;
                stH264FixQp.fr32DstFrameRate = (s32FrameRate > 0)?s32FrameRate:u32FrameRate;
            ...
            else if (SAMPLE_RC_VBR == enRcMode)
            {
                ...
                stH264Vbr.u32Gop           = (s32Gop > 0)?(HI_U32)s32Gop:u32Gop;;
                stH264Vbr.u32StatTime      = u32StatTime;
                stH264Vbr.u32SrcFrameRate  = u32FrameRate;
                stH264Vbr.fr32DstFrameRate = (s32FrameRate > 0)?s32FrameRate:u32FrameRate;
                switch (enSize)
                {
                    case PIC_CIF:
                    case PIC_CIF_ROT:
                ...
                if (s32BitRate > 0)
                    stH264Vbr.u32MaxBitRate = s32BitRate;                
            ...
            else if (SAMPLE_RC_AVBR == enRcMode)
            {
                ...
                stH264AVbr.u32Gop           = (s32Gop > 0)?(HI_U32)s32Gop:u32Gop;;
                stH264AVbr.u32StatTime      = u32StatTime;
                stH264AVbr.u32SrcFrameRate  = u32FrameRate;
                stH264AVbr.fr32DstFrameRate = (s32FrameRate > 0)?s32FrameRate:u32FrameRate;
                switch (enSize)
                {
                    case PIC_CIF:
                    case PIC_CIF_ROT:
                        stH264AVbr.u32MaxBitRate = 512;
                        break;
                ...
                if (s32BitRate > 0)
                    stH264AVbr.u32MaxBitRate = s32BitRate;                 
            ...
            else if (SAMPLE_RC_QVBR == enRcMode)
            {
                ...
                stH264QVbr.u32Gop           = (s32Gop > 0)?(HI_U32)s32Gop:u32Gop;;
                stH264QVbr.u32StatTime      = u32StatTime;
                stH264QVbr.u32SrcFrameRate  = u32FrameRate;
                stH264QVbr.fr32DstFrameRate = (s32FrameRate > 0)?s32FrameRate:u32FrameRate;
                switch (enSize)
                {
                    case PIC_QVGA:    /* 320 * 240 */
                    case PIC_CIF:
                    case PIC_CIF_ROT:	
                        stH264QVbr.u32TargetBitRate = 512;
                        break;
                    ...
                    case PIC_448x768:  
                    case PIC_D1_PAL_ROT:                  	
                        stH264QVbr.u32TargetBitRate = 1024 * 2;
                        break;
                ...
                if (s32BitRate > 0)
                    stH264QVbr.u32TargetBitRate = s32BitRate;                
            ...
            else if(SAMPLE_RC_CVBR == enRcMode)
            {
                ...
                stH264CVbr.u32Gop         = (s32Gop > 0)?(HI_U32)s32Gop:u32Gop;;
                stH264CVbr.u32StatTime    = u32StatTime;
                stH264CVbr.u32SrcFrameRate  = u32FrameRate;
                stH264CVbr.fr32DstFrameRate = (s32FrameRate > 0)?s32FrameRate:u32FrameRate;
            ...
            else if(SAMPLE_RC_QPMAP == enRcMode)
            {
                ...
                stH264QpMap.u32Gop           = (s32Gop > 0)?(HI_U32)s32Gop:u32Gop;;
                stH264QpMap.u32StatTime      = u32StatTime;
                stH264QpMap.u32SrcFrameRate  = u32FrameRate;
                stH264QpMap.fr32DstFrameRate = (s32FrameRate > 0)?s32FrameRate:u32FrameRate;
        ...
        case PT_MJPEG:
        {
            if (SAMPLE_RC_FIXQP == enRcMode)
            {
                ...
                stMjpegeFixQp.fr32DstFrameRate   = (s32FrameRate > 0)?s32FrameRate:u32FrameRate;
            ...
            else if (SAMPLE_RC_CBR == enRcMode)
            {
                ...
                stMjpegeCbr.fr32DstFrameRate    = (s32FrameRate > 0)?s32FrameRate:u32FrameRate;
                switch (enSize)
                {
                    case PIC_360P:
                ...
                if (s32BitRate > 0)
                    stMjpegeCbr.u32BitRate = s32BitRate;  
                     ...
                     (SAMPLE_RC_QVBR == enRcMode)||(SAMPLE_RC_CVBR == enRcMode))
            {
                ...
                stMjpegVbr.u32SrcFrameRate  = (s32FrameRate > 0)?s32FrameRate:u32FrameRate;
                ...
                if (s32BitRate > 0)
                    stMjpegVbr.u32MaxBitRate = s32BitRate;  
                              ...
                              VENC_GOP_ATTR_S *pstGopAttr)
{
    ...
    ******************************************/
    ...
    stVencChnAttr.stVencAttr.u32PicWidth     = pstSize->u32Width;  /*the picture width*/
    stVencChnAttr.stVencAttr.u32PicHeight    = pstSize->u32Height; /*the picture height*/
    stVencChnAttr.stVencAttr.u32BufSize      = pstSize->u32Width * pstSize->u32Height * 2;/*stream buffer size*/
    stVencChnAttr.stVencAttr.u32Profile      = u32Profile;
    stVencChnAttr.stVencAttr.bByFrame        = HI_TRUE;/*get stream mode is slice mode or frame mode?*/
    ...
    switch (enType)
    {
        case PT_H265:
        {
            ...
            else if(SAMPLE_RC_CVBR == enRcMode)
            {
                ...
                stH265CVbr.u32LongTermStatTime  = 1;
                stH265CVbr.u32ShortTermStatTime = u32StatTime;
                stH265CVbr.u32MaxBitRate         = s32BitRate;
                stH265CVbr.u32LongTermMaxBitrate = s32BitRate;
                stH265CVbr.u32LongTermMinBitrate = 512;
                memcpy(&stVencChnAttr.stRcAttr.stH265CVbr, &stH265CVbr, sizeof(VENC_H265_CVBR_S));
            }
            else if(SAMPLE_RC_QPMAP == enRcMode)
        ...
        case PT_H264:
        {
            ...
            else if(SAMPLE_RC_CVBR == enRcMode)
            {
                ...
                stH264CVbr.u32LongTermStatTime  = 1;
                stH264CVbr.u32ShortTermStatTime = u32StatTime;
                stH264CVbr.u32MaxBitRate         = s32BitRate;
                stH264CVbr.u32LongTermMaxBitrate = s32BitRate;
                stH264CVbr.u32LongTermMinBitrate = 512;
...
******************************************************************************/
HI_S32 SAMPLE_COMM_VENC_Start(VENC_CHN VencChn, 
                              PAYLOAD_TYPE_E enType,  
                              SIZE_S * pstSize, 
                              SAMPLE_RC_E enRcMode, 
                              HI_S32  s32FrameRate, 
                              ...
                              VENC_GOP_ATTR_S *pstGopAttr)
{
    ...
    ******************************************/
    s32Ret = SAMPLE_COMM_VENC_Creat(VencChn,enType,pstSize,enRcMode,s32FrameRate,s32BitRate,s32Gop,u32Profile,bRcnRefShareBuf,pstGopAttr);
    if (HI_SUCCESS != s32Ret)
    {
