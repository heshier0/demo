...
#include "rp-lcd-mipi-7inch-1024x600.h"
#include "rp-lcd-mipi-8inch-800x1280.h"
#include "rp-lcd-mipi-10inch-800x1280.h"
#include "rp-lcd-mipi-5inch-720x1280.h"
#include "rp-lcd-mipi-5.5inch-720x1280.h"
#include "rp-lcd-mipi-4inch-480x800.h"
...
/*============== lcd config start added by rpdzkj ivy ================*/
/* mipi lcd config, default 0: mipi 8inch 800x1280 */
//combo_dev_cfg_t *g_mipi_tx_config = NULL;
//VO_SYNC_INFO_S *g_mipi_tx_sync_info = NULL;
//VO_USER_INTFSYNC_INFO_S * g_mipi_tx_user_intfsync_info = NULL;
//lcd_resoluton_t * g_mipi_tx_lcd_resolution = NULL;
//HI_VOID (*g_mipi_lcd_init)(HI_S32 s32fd) = NULL;
//combo_dev_cfg_t *g_mipi_tx_config = &MIPI_TX_8INCH_800X1280_60_CONFIG;
//VO_SYNC_INFO_S *g_mipi_tx_sync_info = &MIPI_TX_8INCN_800X1280_60_SYNC_INFO;
...
/*============== lcd config end added by rpdzkj ivy ================*/
    ...
    switch (enIntfSync)
    {
        ...
        case VO_OUTPUT_7680x4320_30    :
            ...
            *pu32Frm = 30;
            break;
        case VO_OUTPUT_USER    :
            *pu32W = g_mipi_tx_lcd_resolution->pu32W;  
            *pu32H = g_mipi_tx_lcd_resolution->pu32H;
            *pu32Frm = 60;
            break;
        default:
...
HI_S32 SetUserIntfSyncInfo_VO_StartDev(VO_DEV VoDev, VO_PUB_ATTR_S* pstPubAttr)
{
	...
	pstPubAttr->stSyncInfo.u16Vact = 600;  
	pstPubAttr->stSyncInfo.u16Vbb = 18;      
	pstPubAttr->stSyncInfo.u16Vfb = 16;      
	pstPubAttr->stSyncInfo.u16Hact = 1024;   
	pstPubAttr->stSyncInfo.u16Hbb = 64;     
	pstPubAttr->stSyncInfo.u16Hfb = 136;     
	...
	pstPubAttr->stSyncInfo.u16Vact = g_mipi_tx_sync_info->u16Vact;  
	pstPubAttr->stSyncInfo.u16Vbb = g_mipi_tx_sync_info->u16Vbb;      
	pstPubAttr->stSyncInfo.u16Vfb = g_mipi_tx_sync_info->u16Vfb;      
	pstPubAttr->stSyncInfo.u16Hact = g_mipi_tx_sync_info->u16Hact;   
	pstPubAttr->stSyncInfo.u16Hbb = g_mipi_tx_sync_info->u16Hbb;     
	pstPubAttr->stSyncInfo.u16Hfb = g_mipi_tx_sync_info->u16Hfb;     
	pstPubAttr->stSyncInfo.u16Hpw = g_mipi_tx_sync_info->u16Hpw;     
	pstPubAttr->stSyncInfo.u16Vpw = g_mipi_tx_sync_info->u16Vpw;      
	...
	stUserInfo.stUserIntfSyncAttr.stUserSyncPll.u32Fbdiv = g_mipi_tx_user_intfsync_info->stUserIntfSyncAttr.stUserSyncPll.u32Fbdiv;
	stUserInfo.stUserIntfSyncAttr.stUserSyncPll.u32Frac= g_mipi_tx_user_intfsync_info->stUserIntfSyncAttr.stUserSyncPll.u32Frac;
	stUserInfo.stUserIntfSyncAttr.stUserSyncPll.u32Refdiv = g_mipi_tx_user_intfsync_info->stUserIntfSyncAttr.stUserSyncPll.u32Refdiv;
	stUserInfo.stUserIntfSyncAttr.stUserSyncPll.u32Postdiv1 = g_mipi_tx_user_intfsync_info->stUserIntfSyncAttr.stUserSyncPll.u32Postdiv1;
	stUserInfo.stUserIntfSyncAttr.stUserSyncPll.u32Postdiv2 = g_mipi_tx_user_intfsync_info->stUserIntfSyncAttr.stUserSyncPll.u32Postdiv2;
...
static void SAMPLE_PRIVATE_VO_InitMipiTxScreen(VO_INTF_SYNC_E enVoIntfSync, HI_S32 fd)
{
    ...
    else
    {
        ...
        // init screen for 1080x1920_60.
        //SAMPLE_PRIVATE_VO_InitScreen1080x1920(fd);
		//InitScreen1920x1200(fd);
		//InitScreen1024x600(fd);
		g_mipi_lcd_init(fd);
		//InitHiScreen800x1280(fd);
...
void SAMPLE_COMM_VO_StartMipiTx(VO_INTF_SYNC_E enVoIntfSync)
{
    ...
    switch(enVoIntfSync)
    {
		...
		case VO_OUTPUT_USER:
            pstMipiTxConfig = g_mipi_tx_config; 
            break;
        default :
            pstMipiTxConfig = &MIPI_TX_1080X1920_60_CONFIG;
            break;
