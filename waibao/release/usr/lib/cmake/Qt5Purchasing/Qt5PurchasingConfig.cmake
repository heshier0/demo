...
macro(_populate_Purchasing_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Purchasing_install_prefix}/lib/${LIB_LOCATION}")
    ...
    set_target_properties(Qt5::Purchasing PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5Purchasing.so.5"
...
if (NOT TARGET Qt5::Purchasing)
    ...
    _populate_Purchasing_target_properties(RELEASE "libQt5Purchasing.so.5.9.8" "" )
