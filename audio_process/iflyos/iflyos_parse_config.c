...
{
    utils_reload_cfg(IFLYOS_CFG, g_cfg_root);
}
...
BOOL iflyos_set_client_id(const char* value)
{
    ...
    return utils_set_cfg_str_value(g_cfg_root, IFLYOS_CFG, DEVICE_PARAMS, "client_id", value);
}
...
BOOL iflyos_set_grant_type(const char* value)
{
    ...
    return utils_set_cfg_str_value(g_cfg_root, IFLYOS_CFG, DEVICE_PARAMS, "grant_type", value);
}
...
BOOL iflyos_set_device_code(const char* value)
{
    ...
    return utils_set_cfg_str_value(g_cfg_root, IFLYOS_CFG, DEVICE_PARAMS, "device_code", value);
}
...
BOOL iflyos_set_device_id(const char* value)
{
    ...
    return utils_set_cfg_str_value(g_cfg_root, IFLYOS_CFG, DEVICE_PARAMS, "device_id", value);
}   
...
BOOL iflyos_set_token_type(const char* value)
{
    ...
    return utils_set_cfg_str_value(g_cfg_root, IFLYOS_CFG, DEVICE_AUTH, "token_type", value);
}
...
BOOL iflyos_set_token(const char* value)
{
    ...
    return utils_set_cfg_str_value(g_cfg_root, IFLYOS_CFG, DEVICE_AUTH, "access_token", value);
}
...
BOOL iflyos_set_refresh_token(const char* value)
{
    ...
    return utils_set_cfg_str_value(g_cfg_root, IFLYOS_CFG, DEVICE_AUTH, "refresh_token", value);
}
...
BOOL iflyos_set_expired_time(const long times)
{
    ...
    return utils_set_cfg_number_value(g_cfg_root, IFLYOS_CFG, DEVICE_AUTH, "expires_in", times);
}
...
BOOL iflyos_set_created_time(const long times)
{
    ...
    return utils_set_cfg_number_value(g_cfg_root, IFLYOS_CFG, DEVICE_AUTH, "created_at", times);
}
...
BOOL iflyos_set_platform_name(const char* value)
{
    ...
    return utils_set_cfg_str_value(g_cfg_root, IFLYOS_CFG, PLATFORM_PARAMS, "name", value);
}
...
BOOL iflyos_set_platform_version(const char* value)
{
    ...
    return utils_set_cfg_str_value(g_cfg_root, IFLYOS_CFG, PLATFORM_PARAMS, "version", value);
}
...
BOOL iflyos_set_system_version(const char* value)
{
    ...
    return utils_set_cfg_str_value(g_cfg_root, IFLYOS_CFG, SYSTEM_PARAMS, "version", value);
}

BOOL iflyos_set_system_sw_updater_state(const BOOL value)
{
    return (BOOL)utils_set_cfg_number_value(g_cfg_root, IFLYOS_CFG, SYSTEM_PARAMS, "software_updater", value);
}

BOOL iflyos_set_system_power_ctrl_state(const BOOL value)
{
    return (BOOL)utils_set_cfg_number_value(g_cfg_root, IFLYOS_CFG, SYSTEM_PARAMS, "power_controller", value);
}

BOOL iflyos_set_system_device_modes_state(const BOOL value)
{
    return (BOOL)utils_set_cfg_number_value(g_cfg_root, IFLYOS_CFG, SYSTEM_PARAMS, "device_modes", value);
}

BOOL iflyos_set_system_reboot_state(const BOOL value)
{
    return (BOOL)utils_set_cfg_number_value(g_cfg_root, IFLYOS_CFG, SYSTEM_PARAMS, "reboot", value);
}
...
BOOL iflyos_set_audio_version(const char* value)
{
    ...
    return utils_set_cfg_str_value(g_cfg_root, IFLYOS_CFG, AUDIO_PLAYER, "version", value);
}
...
{    
    ...
    return utils_set_cfg_str_value(g_cfg_root, IFLYOS_CFG, AUDIO_PLAYER, "state", value);
}